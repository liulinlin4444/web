...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'seo', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是刘林麟PopLin🎉更新极慢，脾气不好， 口遁嘴炮，百无禁忌。 不站队，不定期，不负责。',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'PopLin', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '街舞圈一码字儿的。 圈内爆料、槽点、评论、没品段子。🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://needayeah.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '鉴黄老司机, needayeah', // 网站关键词 英文逗号隔开
